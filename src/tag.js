...
const INTENTS = new Set(['decision', 'input', 'fyi']);
...
// Builds the X-PTO-Triage header value for an intent. decision/input may carry an
// optional ';by=YYYY-MM-DD' deadline; fyi never does.
...
// Maps a header intent (canonical or legacy) to the canonical lane id. The retired
// respond/review tags fold into 'input' and approve into 'decision' so mail tagged
// by an older add-in still classifies.
const INTENT_ALIASES = {
  decision: 'decision', approve: 'decision', action: 'decision',
  input: 'input', respond: 'input', review: 'input', blocked: 'input', whenever: 'input',
  fyi: 'fyi',
};
